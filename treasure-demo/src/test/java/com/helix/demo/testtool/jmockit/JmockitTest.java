package com.helix.demo.testtool.jmockit;
...
//	    System.out.println(new UserService().getUserName(5));//userService.userDao nullPointException
    ...
    @Injectable
    UserDao userDaoByInjectTableForTested;
    ...
    @Test
    public void testMockUpAndMock(@Mocked UserDao userDao) {
...
//        UserDao userDao = proxyStub.getMockInstance();
     ...
     */
    @Test
    public void testMockUpAndMock2(@Capturing UserService service) {
