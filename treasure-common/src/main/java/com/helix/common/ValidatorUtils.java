...
public class ValidatorUtils {
     ...
     * @return
     */
    public static boolean isBusinessLicense(String license){
        if (Objects.isNull(license)) {
            return false;
        }
        if(license.length() == 15){
            return isBusinessLicense15(license);
        }else if(license.length() == 18){
            return isBusinessLicense18(license);
        }else{
            return false;
        }
    }
     ...
     * @return
     */
    public static boolean isBusinessLicense15(String license) {
        if (Objects.isNull(license)) {
            return false;
        }
        if (license.length() != 15) {
